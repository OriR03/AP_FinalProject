...
public class ConcatAgent implements Agent {
    ...
    public ConcatAgent(String[] subs, String[] pubs) {
        ...
        this.name="concat agent"+this.counter;
        this.counter++;
    }
    @Override
    ...
    public void reset() {
        ...
        this.callback(subs[1], new Message(""));
    }
    ...
    public void callback(String topic, Message msg) {
        ...
        if(Messages.containsKey(subs[0]) && Messages.containsKey(subs[1])) {//publishing the msg
            String x = Messages.get(subs[0]).asText;
            String y = Messages.get(subs[1]).asText;
            tm.getTopic(pubs[0]).publish(new Message(x.concat(y)));
        }
    }
