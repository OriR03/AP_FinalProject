...
public class UpperCaseAgent implements Agent {
    ...
    public UpperCaseAgent(String[] subs, String[] pubs) {
        ...
        this.name="uppercase agent"+this.counter;
        this.counter++;
    }
    @Override
    ...
    public void callback(String topic, Message msg) {
        ...
        if(Messages.containsKey(subs[0])) {//publishing the msg
            String x = Messages.get(subs[0]).asText.toUpperCase();
